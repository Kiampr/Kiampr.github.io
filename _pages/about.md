...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.2rem; margin-top: 1rem;">
  ...
  <div style="border: 1px solid #ddd; border-radius: 10px; padding: 1.2rem; background: #f9f9f9; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
    ...
    <a href="https://www.researchgate.net/profile/Kiarash-Mansour-Pour" target="_blank" rel="noopener noreferrer" style="font-size: 0.82rem; background: #2a7ae2; color: white; padding: 0.3rem 0.7rem; border-radius: 5px; text-decoration: none;">📄 Paper</a>
  </div>

  <div style="border: 1px solid #ddd; border-radius: 10px; padding: 1.2rem; background: #f9f9f9; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
    <div style="font-size: 2rem; margin-bottom: 0.5rem;">⚙️</div>
    <h4 style="margin: 0 0 0.4rem;">Nonlinear Solvers for Compositional Transport</h4>
    <p style="font-size: 0.88rem; color: #555; margin: 0 0 0.8rem;">Mathematical models and nonlinear solvers for coupled wellbore-reservoir compositional transport in subsurface energy systems.</p>
    <a href="https://www.researchgate.net/profile/Kiarash-Mansour-Pour" target="_blank" rel="noopener noreferrer" style="font-size: 0.82rem; background: #2a7ae2; color: white; padding: 0.3rem 0.7rem; border-radius: 5px; text-decoration: none;">📄 Paper</a>
  </div>

  <div style="border: 1px solid #ddd; border-radius: 10px; padding: 1.2rem; background: #f9f9f9; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
    <div style="font-size: 2rem; margin-bottom: 0.5rem;">🌍</div>
    <h4 style="margin: 0 0 0.4rem;">Digital Twin for Subsurface Systems</h4>
